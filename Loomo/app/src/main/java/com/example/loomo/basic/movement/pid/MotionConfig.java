...
public class MotionConfig {
    ...
    public static final float DIST_KP_DISABLE_THRE = 0.3f;
    ...
    public static final int DIST_TI = 3; // The number of data for integral
    public static final float MAX_LINEAR_I_SPEED = 1.0f;
